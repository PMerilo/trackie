...
const links = [
  ...
  { name: 'Camera Cofiguration', href: '/cameraConfig' },
  { name: 'Start & Stop Prediction', href: '/togglePrediction' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-1 bg-gray-800 p-5 rounded-lg shadow-xl">
            <div className="flex items-center">
              <Image
                src="https://img.icons8.com/?size=80&id=0lg0kb05hrOz&format=png"  // Replace with your image path
                width={160}
                height={160}
